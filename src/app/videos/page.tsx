...
export const metadata: Metadata = {
  title: 'Videos',
  description:
    'Real travel, packing guides, digital nomad prep, and weekly vlogs from Rachel and Christian — organized so you can actually find what you need.',
}
    ...
    <>
      ...
      <section className="bg-brand-black">
        <div className="max-w-7xl mx-auto px-5 lg:px-8 py-16 lg:py-20 text-center">
          ...
          <p className="font-jost font-light text-white/60 max-w-md mx-auto mb-8 leading-relaxed">
