    ...
    <>
      ...
      <section className="bg-brand-black pt-32 pb-16 lg:pb-20">
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          ...
          <p className="font-jost text-xs text-white/35 max-w-xl leading-relaxed mb-6">
            Disclosure: This page contains affiliate links. If you purchase through our links, we may earn a small commission at no extra cost to you. We only recommend products we personally use and trust.
          </p>
      ...
      <section className="bg-beige">
        <div className="max-w-3xl mx-auto px-5 lg:px-8 py-14 lg:py-20">
          ...
          <h2 className="font-playfair font-bold text-2xl lg:text-3xl text-brand-black leading-tight mb-3 tracking-tight">
            Want the complete one-bag packing list?
          </h2>
          <p className="font-jost font-light text-sm text-muted leading-relaxed mb-7">
            Everything that made the cut — and everything we left behind. Join our list and we&apos;ll send it straight to your inbox, plus our Digital Nomad Quick Start Guide free.
          </p>
          <KitSignupForm
            buttonLabel="Get the Packing List"
      ...
      <section className="bg-brand-black">
        <div className="max-w-3xl mx-auto px-5 lg:px-8 py-14 text-center">
          <h2 className="font-playfair font-bold text-2xl text-white mb-4 tracking-tight">
            See the full storefront on Amazon.
          </h2>
          <p className="font-jost font-light text-sm text-white/60 mb-8 leading-relaxed">
