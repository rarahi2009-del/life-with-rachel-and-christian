...
const TRAVEL_TOOLS = [
  ...
  {
    name: 'Tello',
    logo: '/images/logos/tello.png',
    category: 'US Phone Plan',
    description:
      'The affordable US phone plan we use while home. No contracts, no bloated bills — just reliable coverage on T-Mobile\'s network. Perfect for nomads who need to keep a US number.',
    href: 'https://tello.com/account/register?_referral=P3DSK9N9',
  },
  {
    name: 'US Global Mail',
    logo: '/images/logos/usglobalmail.svg',
    category: 'Virtual Mailbox',
    description:
      'A real US mailing address you can access from anywhere in the world. They scan, forward, or shred your mail on demand — essential if you\'re living abroad long-term.',
    href: 'https://usglobalmail.com/pricing/?referral_code=RACHEL-MML5ZEKE.KD',
  },
]
...
export default function AffiliatesPage() {
  return (
    <>
      {/* ── HEADER ───────────────────────────────────────────────────────── */}
      <section className="bg-[#0A0A0A] pt-32 pb-16 lg:pb-20">
