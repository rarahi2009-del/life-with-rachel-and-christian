  ...
  return (
    <>
      ...
      <article className="max-w-3xl mx-auto px-5 lg:px-8 py-12 lg:py-16">
        ...
        <div className="mt-12 bg-[#0A0A0A] p-8 lg:p-10">
          <p className="font-jost text-[10px] font-medium tracking-[0.22em] uppercase text-gold mb-3">
            Free Guide
          </p>
          <h3 className="font-playfair font-bold text-2xl text-white leading-tight mb-3">
            Get our Digital Nomad Quick Start Guide free.
          </h3>
          <p className="font-jost font-light text-sm text-white/60 leading-relaxed mb-6">
            21 pages of honest, practical advice for anyone thinking about the digital nomad life — real budgets, remote job options, and what nobody tells you before you go. Join the list and it&apos;s yours.
          </p>
          <KitSignupForm
        ...
        {/* Byline */}
        <div className="mt-10 pt-8 border-t border-divider flex items-center gap-4">
          <div>
